...
export const Navbar = () => {
  ...
  const { paletteTooltip, languageTooltip } = useNavbarTooltips();
          ...
          <div className="flex items-center gap-[0.5rem] md:gap-2 xl:gap-7 z-[99]">
            ...
            <div className="mr-1 2xl:-mr-unset">
              <button
                ...
                className="transition text-sm 2xl:text-base ml-2 hidden xl:flex rounded-xl w-40 h-9 2xl:h-10 justify-center items-center font-medium border !border-mainColor text-primaryText hover:bg-navbarButtonBgHover bg-navbarButtonBg text-white disabled:opacity-70"
              >
                Upload Data
              </button>
            </div>
