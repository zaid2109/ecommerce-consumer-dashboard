...
export const ProductDetails = ({
  ...
  const showProfit = typeof activeProduct.profit === "number";
  const showMarkup = typeof activeProduct.markupRate === "number";
            ...
            <div className="flex text-sm md:text-base 3xl:text-xl gap-2 xsm:gap-4 md:gap-8 mt-2 xsm:mt-3 2xl:mt-4 flex-col xsm:flex-row">
              ...
              {showMarkup && (
                <div className="flex gap-1">
                  ...
                  <p className="text-primaryText">{activeProduct.markupRate?.toFixed(1)}%</p>
                </div>
              )}
              {showProfit && (
                <div className="hidden md:flex gap-2">
                  <p className="text-secondaryText">{t("header.profit")}:</p>
                  <p className="text-primaryText">${activeProduct.profit?.toFixed(2)}</p>
                </div>
              )}
            </div>
          </div>
